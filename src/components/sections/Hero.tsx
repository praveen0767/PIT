...
export function Hero() {
  return (
    <section className="relative min-h-[100svh] flex flex-col justify-center pt-24 pb-8 overflow-hidden bg-pit-black">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-pit-white mb-4 leading-[1.1] drop-shadow-2xl">
            ...
            <p className="text-base md:text-lg text-pit-offwhite opacity-80 mb-6 leading-relaxed max-w-xl font-light">
            ...
            {/* Credibility Row */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-2xl border-t border-pit-white/10 pt-6">
          ...
          <motion.div
            ...
            className="lg:col-span-6 relative w-full aspect-square md:aspect-video lg:aspect-square flex items-center justify-center mt-8 lg:mt-0"
          >
